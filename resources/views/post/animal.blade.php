...
@section('start')
    ...
    <main class="container">
        ...
        <div class="p-4 p-md-5 mb-4 rounded text-bg-dark" style="background-image: url('https://abrakadabra.fun/uploads/posts/2022-01/1643265733_5-abrakadabra-fun-p-pantera-na-zastavku-7.jpg');">
            <div class="col-md-6 px-0">
                <h1 class="display-4 fst-italic">"На этой страничке постики про живность"</h1>
