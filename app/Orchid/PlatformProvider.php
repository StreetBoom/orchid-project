...
class PlatformProvider extends OrchidServiceProvider
{
    ...
    public function registerMainMenu(): array
    {
        return [
            ...
            Menu::make('Посты')
                ->icon('book-open')
                ->list([
                    Menu::make('Посты про животных')->icon('bag')->route('posts'),
                    Menu::make('Посты про спорт')->icon('bag')->route('posts'),
                ]),
    ...
    public function registerPermissions(): array
    {
        return [
            ...
            ItemPermission::group('Работа с постами')
                ->addPermission('platform.posts', 'Посты')
